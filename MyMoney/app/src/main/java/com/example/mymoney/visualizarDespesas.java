...
public class visualizarDespesas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visualizar_despesas);
        ...
        if(indicador == 0) {
            ab.setTitle("Despesas Ocasionais");
        }
        else if(indicador == 1){
            ab.setTitle("Despesas Fixas");
        }
        else{
            ab.setTitle("Totais Mensais");
        }

        fat_next = (FloatingActionButton) findViewById(R.id.fat_nextdespesa);
        db = new DBHelper(this);
        listView = (ListView) findViewById(R.id.lv_despesas);

        if(indicador == 0){
            AdapterFinanca adapter = new AdapterFinanca(this,db.selectFinancas("despesa", "ocasional"));
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    new AlertDialog.Builder(visualizarDespesas.this)
        ...
        if(indicador == 1){
            AdapterFinanca adapter = new AdapterFinanca(this,db.selectFinancas("despesa", "fixa"));
            listView.setAdapter(adapter);
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
    ...
    public void alterar(int cod, String tipo, String subtipo, String descricao, String valor){
        Intent intent = new Intent(this, alterarGastoFixo.class);
    ...
    public void sair(){
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        //visualizarDespesas.this.finish();
                        System.exit(0);
                    }
                })
                .setNegativeButton("Não", null)
